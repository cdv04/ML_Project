...
Data used in this project come from accelerometers on the belt, forearm, arm, and dumbell of 6 participants. They were asked to perform barbell lifts correctly and incorrectly in 5 different ways. More information is available from the website here: http://groupware.les.inf.puc-rio.br/har (see the section on the Weight Lifting Exercise Dataset).


Using the data of these 6 participants the aim of the project is to train a model to predict the manner in which 20 participants did the exercise. 
...
Training data contains 159 possible explanatory variables, and 196622 observations !
...
Some variables seem to be factor by error and contains #DIV/0!". I choose to remove these factor variables.


##3. Explanatory variables selection


###3.1 Remonving false factor variable
...
Using the df_status function of the funModeling package, we can see that some variables contain a high percentage of missing values. I'm going to remove those variables having more than 10% of NA values using code available in *Casas, Pablo. Data Science Live Book: An intuitive and practical approach to data analysis, data preparation and machine learning, suitable for all ages! (p. 13). Édition du Kindle*.   
...
X variable has no information, is row index
